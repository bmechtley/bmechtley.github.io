...
export const parameters = {
  ...
  vis_density: {
    ...
    high: {value: [0.0048, 0.002, 785, 1], min: [0, 0, 0, 0], max: [0.1, 0.1, 1000, 1], step: [0.01, 0.01, 0.01, 0.01]},
    low: {value: [0, 0, 230, 0], min: [0, 0, 0, 0], max: [0.1, 0.1, 1000, 1], step: [0.01, 0.01, 0.01, 0.01]},
    source_vars: {value: [0, 1, 2, 3], min: [0, 0, 0, 0], max: [3, 3, 3, 3], step: [1, 1, 1, 1]}
  }
};
